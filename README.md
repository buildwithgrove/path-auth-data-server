...
For more details, see the [Grove Portal DB Driver Readme](https://github.com/buildwithgrove/path-auth-data-server/blob/main/postgres/grove/grove_postgres.md) documentation.
